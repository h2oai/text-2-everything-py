...
function useDocsSearchVersionsHelpers() {
  ...
  /* ----START CHANGE --- */
  /* This change was necessary due to an open bug: https://github.com/facebook/docusaurus/issues/3805
   * In current plugin implementation, disabling contextual search does not disable version faceting
   * on the search page (which leads to weird search results). When this bug is resolved hopefully we
   * can bump the version and un-swizzle this component. */
